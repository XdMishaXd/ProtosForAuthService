...
const file_sso_sso_proto_rawDesc = "" +
	"\n" +
	"\rsso/sso.proto\x12\x04auth\"\x7f\n" +
	...
	"\x05email\x18\x03 \x01(\tR\x05email2\xe3\x01\n" +
	"\x04Auth\x129\n" +
	"\bRegister\x12\x15.auth.RegisterRequest\x1a\x16.auth.RegisterResponse\x120\n" +
	"\x05Login\x12\x12.auth.LoginRequest\x1a\x13.auth.LoginResponse\x126\n" +
	"\aIsAdmin\x12\x14.auth.IsAdminRequest\x1a\x15.auth.IsAdminResponse\x126\n" +
	"\aGetUser\x12\x14.auth.GetUserRequest\x1a\x15.auth.GetUserResponseB\x11Z\x0fpm.sso.v1;ssov1b\x06proto3"
...
var file_sso_sso_proto_depIdxs = []int32{
	...
	7, // 7: auth.Auth.GetUser:output_type -> auth.GetUserResponse
